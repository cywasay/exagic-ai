...
export default function AEOInclusionChart() {
  const data = [
    { label: "Traditional SEO Only", value: 12, color: "bg-zinc-200" },
    { label: "Exagic AEO Optimized", value: 89, color: "bg-brand" },
  ];
    ...
    <div className="bg-white p-8 rounded-3xl border border-zinc-100 shadow-sm relative overflow-hidden group">
      <div className="flex flex-col mb-10">
        ...
        <p className="text-xs text-zinc-500 mt-1">
          Likelihood of brand citation in synthesized AI responses
        </p>
      </div>
      ...
      <div className="mt-10 pt-6 border-t border-zinc-50 italic text-[10px] text-zinc-400 font-medium leading-relaxed">
        * Data based on internal testing across GPT-4o, Claude 3.5 Sonnet, and
        Perplexity Pro for industrial procurement queries.
      </div>
    </div>
  );
}
