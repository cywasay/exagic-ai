...
export default function SROOperationalChart() {
  const steps = [
    {
      num: "01",
      title: "Latency Analysis",
      desc: "Measuring model default preference",
    },
    {
      num: "02",
      title: "Authority Framing",
      desc: "Injecting technical trust signals",
    },
    {
      num: "03",
      title: "Probability Tuning",
      desc: "Refining semantic citable chunks",
    },
    {
      num: "04",
      title: "Selection Tracking",
      desc: "Monitoring actual citation wins",
    },
  ];
  ...
  return (
    <div className="bg-white p-8 rounded-3xl border border-zinc-100 shadow-sm relative overflow-hidden group">
      <div className="flex flex-col mb-10">
        ...
        <h3 className="text-xl font-bold text-zinc-900">The SRO Engine</h3>
      </div>
