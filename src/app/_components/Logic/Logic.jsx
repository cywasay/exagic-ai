    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          <article className="rounded-xl border border-zinc-200 bg-white p-8 shadow-sm transition-all hover:shadow-md">
            <div className="mb-6 inline-flex h-10 w-10 items-center justify-center rounded-lg bg-zinc-100 text-brand text-lg font-bold">
              01
            </div>
